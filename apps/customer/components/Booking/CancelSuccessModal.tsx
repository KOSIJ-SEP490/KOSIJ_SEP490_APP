      ...
      <View className='flex-1 justify-center items-center bg-black/50'>
        <View className='bg-white w-11/12 max-w-md rounded-2xl p-6'>
          <View className='items-center mb-4'>
            ...
            <Text className='text-lg text-gray-700 font-medium'>Cancel Success!</Text>
          </View>
          ...
          <View className='space-y-6'>
            ...
            <View className='flex-row justify-between'>
              <Text className='text-base text-gray-600'>Canceled Time</Text>
              <Text className='text-base text-gray-800'>{canceledTime}</Text>
            </View>

            <View className='flex-row justify-between'>
              <Text className='text-base text-gray-600'>Cancellation Reason</Text>
              <Text className='text-base text-gray-800'>{cancellationReason}</Text>
            </View>
            ...
            <View className='flex-row justify-between'>
              <Text className='text-base text-gray-600'>Refund Amount</Text>
              <Text className='text-base text-gray-800'>{refundAmount.toLocaleString()} VND</Text>
            </View>
          </View>
